...
namespace Domain.Interfaces
{
    public interface IReadSensorDataRepository
    {
        ...
        Task SaveProcessingStatsAsync( ProcessedStats stats, CancellationToken cancellationToken = default);

        Task<ProcessedStats?> GetProcessedStatsAsync( CancellationToken cancellationToken = default);

        Task<IEnumerable<Reading>> GetByDeviceAndMetricAsync( string deviceId, string metric,
